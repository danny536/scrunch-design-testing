          ...
          <PieChart>
            ...
            <Pie data={chartData} dataKey="visitors" nameKey="browser" innerRadius={60} strokeWidth={5}>
              <text x="50%" y="50%" textAnchor="middle" dominantBaseline="middle">
                <tspan x="50%" dy="-0.5em" className="fill-foreground text-3xl font-bold">{total.toLocaleString()}</tspan>
                <tspan x="50%" dy="1.4em" className="fill-muted-foreground">Visitors</tspan>
              </text>
            </Pie>
          </PieChart>
        </ChartContainer>
