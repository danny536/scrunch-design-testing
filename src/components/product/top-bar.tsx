...
import { BookOpen, ChevronDown, ChevronsUpDown, Search } from "lucide-react"
  ...
  return (
    <div className="flex h-14 w-full shrink-0 items-center gap-2 border-b border-ink/[12%] bg-paper px-3">
      ...
      <div className="ml-auto flex items-center gap-3">
        <button className="flex items-center gap-1.5 rounded-scrunch-md px-2.5 py-1.5 text-sm text-ink/70 hover:bg-s-neutral-100 hover:text-ink transition-colors">
